...
public class ResultReporter {
	...
	public static void reportError(String summary, String detailedMessage, Throwable e) {
	...
	private static void submitMessage(Severity severity, String summary, String detailedMessage) {
		FacesContext context = FacesContext.getCurrentInstance();
		FacesMessage message = new FacesMessage(severity, summary, detailedMessage);	
